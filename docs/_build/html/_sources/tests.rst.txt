...
Source: `Pandoc’s User Guide <http://pandoc.org/README.html>`__
...
Pandoc does not conform to its documentation when title blocks use

multiple lines with leading space. The corresponding examples have been
